...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../../css/sidepanel.css"><link rel="stylesheet" type="text/css" href="../../css/top_navigation.css">
        ...
        <style type="text/css">
            ...
            th{background-color: #002b80;color: white;border-radius: 10px ; padding-left:4%; padding-right:4%;}
            body
            {
