...
<body>
  <div class="sidebar">
    ...
    <center><img src="../../icons/logo.png" style="width:80px;height:80px;" >
      ...
      <a class="active" href="accountS2e1.php">Account Settings</a>
      <a href="../../login/logout.php" target="_self" style="all:unset ;"><button id="logout" style="margin-top: 70%;margin-left: 25%">Log out</button></a>
