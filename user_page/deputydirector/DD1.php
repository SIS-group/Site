...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding"><i class="fa fa-dashboard"></i>  Paper Marking Progress</a>
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding w3-blue"><i class="fa fa-eye fa-fw"></i>  Verify Result Sheet</a>
...
<form action="deputydirector/DD1.php" method="POST">
  <table class="w3-table">
    ...
    <?php
                ...
                $sql = "SELECT CourseID, Examiner_ID, Examiner_Level, Verifying_status, Marking_Status, Issues_changes, Release_Date FROM result ORDER BY CourseID ASC";
            ...
            ?>
                      <tr>
                          ...
                          <td nowrap="true" style="text-align: center;"><?php echo $row['Examiner_Level']; ?></td>
                          ...
                          <td nowrap="true"style="text-align: center;"><?php echo $row['Issues_changes']; ?></td>
