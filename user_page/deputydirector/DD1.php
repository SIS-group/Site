...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="DD2.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users"></i>  Student Results & Grades</a>
...
<form action="deputydirector/DD1.php" method="POST">
  <table class="w3-table">
    ...
    <?php
                ...
                $sql = "SELECT CourseID, Examiner_ID, Examiner_Level, Verifying_status, Marking_Status,Release_Date FROM result ORDER BY CourseID ASC";
