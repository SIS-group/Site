...
<body>
	<div class="sidebar">
		...
		<a class="active" href="yearviceStudentpersonal2.php">Student Personal Details</a>
...
<div class="mybox">
  <a href="year1studentpersonal2.php" class="button">First year students</a>
  <a href="year2studentpersonal2.php" class="button">Second year students</a>
  <a href="year3studentpersonal2.php" class="button">Third year students</a>
  <a href="year4studentpersonal2.php" class="button">Fourth year students</a>
  <a href="allyearsstudentpersonal2.php" class="button">All students</a>
</div>
