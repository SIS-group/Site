...
<body>
  <div class="sidebar">
    ...
    <a href="yearviceStudentpersonal2.php">Student Personal Details</a>
      ...
      <a class="active"  href="coursestatprogram2.php">Course Statistic</a>
  ...
  <div class="mybox">
      ...
      <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for Program_Name.." title="Type in a Program_Name">
  <table id="customers">
  <tr>
    <th>ProgramID</th>
    <th>Program Name</th>
      ...
      <?php
            ...
            ?>
                      <tr>
                          ...
                          <td align='center'><form method="get" action="coursestatcourse2.php"><input type=submit name="phpVariable" value="<?php echo $row['ProgramID']; ?>" style="width:100%"></form></td>
