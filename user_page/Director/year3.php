  ...
  <tr>
    ...
    <th>Credits</th>
      ...
      <?php
                ...
                $sql = "SELECT CourseID,Name ,Semester, Credits FROM course WHERE Year='3' ORDER BY Semester ASC";
            ...
            ?>
                      <tr>
                          ...
                          <td align='center'><form method="get" action="coursevise.php"><input type=submit name="phpVariable" value="<?php echo $row['CourseID']; ?>" style="width:100%"></form></td>
