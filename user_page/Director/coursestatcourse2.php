...
<body>
  ...
  <h2>View Results</h2>
    ...
    <h2 style="text-align: center; margin-top: 5%; margin-bottom:0%;"> ProgramID: <?php echo $phpVariable; ?> </h2>
  <div class="mybox">
    <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search for CourseID.." title="Type in an CourseID">
    <table id="customers">
  <tr>
