...
<body>
	<div class="sidebar">
		...
		<a class="active" href="yearviceStudentpersonal.php">Student Personal Details</a>
		<a href="#">Notification</a>
  		<a href="paymentdetails.php">Student Payment Details</a>
  		<a href="coursestatprogram.php">Course Statistic</a>
  		<a href="yearvice.php">Student results and grades</a>
