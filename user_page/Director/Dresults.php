...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="PD2.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-users"></i>  Student Results & Grades</a>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-eye"></i> Student Results & Grades </b></h5>
  </header>
<form action="DD1.php" method="POST">
  <table class="w3-table">
    ...
    <?php
                ...
                $sql = "SELECT CourseID, IndexNo,Result FROM student_results ORDER BY CourseID ASC";
