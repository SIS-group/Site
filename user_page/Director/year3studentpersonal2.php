  ...
  <tr>
    ...
    <th>Address</th>
      ...
      <?php
                ...
                FROM ((course INNER JOIN student_result ON course.CourseID=student_result.CourseID ) INNER JOIN student ON student.IndexNo= student_result.IndexNo) WHERE course.Year='3' ";
